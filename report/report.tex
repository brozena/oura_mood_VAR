...
\begin{abstract}%
  ...
  selection, a vector autoregressive (VAR) model was employed along with Granger
  ...
  self-reported presence of depressed mood using a VAR(3) model. \end{abstract}
...
Self-tracking technologies have dramatically improved the quality of information
...
\begin{table}[h]
  ...
  \begin{tabular}{lr}
  \toprule
    \textbf{Sleep Scores} & \textbf{Value} \\ \midrule
      Total nights & 1455 \\
      Missing nights & 1 \\
      Mean & 73.82 \\
      SD & 12.36 \\
   ...
   \bottomrule
  \end{tabular}
\caption{Descriptive statistics of sleep score data}
\label{Sleep}
\end{table}
